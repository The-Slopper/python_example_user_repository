...
User Repository segue boas praticas of engenharia: estrutura of projeto idiomatica,
...
```text
python_example_user_repository/
  pyproject.toml
  src/
    user_repository.py
  tests/
...
- **Public repository:** <https://github.com/the-slopper/python_example_user_repository>
